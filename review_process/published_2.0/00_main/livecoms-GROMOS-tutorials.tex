...
\author[1,2]{Radek Crha}
\author[1]{Oriol Gracia Carmona}
\author[3]{Julia Gebhardt}
\author[1]{Christoph \"Ohlknecht}
\author[1,4]{Peter Poliak}
\author[1]{Peter Fraško}
\author[1]{Anita de Ruiter}
\author[3]{Marcelle B. M. Spera}
\author[1,2]{Michael Gillhofer}
%\author[3]{Coauthor(s) Zurich}
%\author[1,2\authfn{1}\authfn{3}]{Firstname Middlename Familyname}
%\author[2\authfn{1}\authfn{4}]{Firstname Initials Surname}
\author[5]{Wilfred F. van Gunsteren}
\author[1*,2]{Chris Oostenbrink}
\author[3*]{Niels Hansen}
\affil[1]{Institute of Molecular Modeling and Simulation, University of Natural Resources and Life Sciences, Vienna, Austria}
\affil[2]{Christian Doppler Laboratory for Molecular Informatics in the Biosciences, University of Natural Resources and Life Sciences, Vienna, Austria}
\affil[3]{Institute of Thermodynamics and Thermal Process Engineering, University of Stuttgart, Stuttgart, Germany}
\affil[4]{Institute of Physical Chemistry and Chemical Physics, Slovak University of Technology, Bratislava, Slovakia}
\affil[5]{Institute of Molecular Physical Science, Swiss Federal Institute of Technology, ETH, Z\"urich, Switzerland}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\pubDOI{10.33011/livecoms.6.1.3485}
\pubvolume{6}
\pubissue{1}
\pubyear{2025}
\articlenum{3485}
\datereceived{December 18, 2024}
\dateaccepted{September 4, 2025}
...
\input{../02_prerequisites/prerequisites.tex}
...
\input{../04_tutorial_01/tutorial_01.tex}

\input{../05_tutorial_02/tutorial_02.tex}

\input{../06_tutorial_03/tutorial_03.tex}

\input{../07_tutorial_04/tutorial_04.tex}

\input{../08_tutorial_05/tutorial_05.tex}

\input{../09_tutorial_06/tutorial_06.tex}

...
The most common error in setting up GaMD simulations is creating an undesired or erroneous selection of parameters for the accelerations and interaction groups. In the best case scenario, the selected inputs would be incompatible and will crash, worse case, the simulation will run without errors but the resulting acceleration may not match the ones desired by the user.
